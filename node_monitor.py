...
from api_utils import send_nodeconfig
...
class NodeStateInformer:
    ...
    def __init__(self,
        ...
        self.api_endpoint = (
            f"https://{self.api_server}/api/resources/computejob/v1/NodeConfig"
        )
    ...
    def _process_object(self, obj: Dict, is_deleted: bool) -> None:
        ...
        interfaces = ([] if is_deleted else _extract_interfaces_from_state(
            obj, self.node_interface_type))
