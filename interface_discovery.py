...
def create_or_update_nodestate(api: client.CustomObjectsApi, node_name: str,
        ...
        if not cache.initialized:
            ...
            try:
                ...
                if e.status == 404:
                    ...
                    # Initialize cache with created resource's resourceVersion
                    cache.interfaces = interfaces
                    cache.resource_version = created["metadata"][
                        "resourceVersion"]
                    cache.initialized = True
                    return True
                else:
...
def main():
    ...
    while True:
        try:
            ...
            create_or_update_nodestate(api, node_name, interfaces, cache)
