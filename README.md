...
3. **ClusterRole**: `cv-job-informer` (cluster-wide permissions to watch jobs, pods, and node interface states)
...
<details>
<summary><b>Event Flow Diagram</b></summary>
...
<details>
<summary><b>How cv-job-informer works</b></summary>
...
**What it needs:**
- Read-only access to pods and job CRDs (via RBAC)
...
<details>
<summary><b>How cv-interface-discovery works</b></summary>
...
- When a CR is created/updated, extracts the interface inventory
- Sends the node's interface list to CloudVision NodeConfig API
...
<details>
<summary><b>Example API Payloads Sent to CloudVision</b></summary>
