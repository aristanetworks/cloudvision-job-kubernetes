...
def send_jobconfig(api_endpoint: str,
                   api_token: str,
                   job_id: str,
                   job_name: str,
                   location: str,
                   ...
                   jobconfig_mode: str = 'interface') -> bool:
    """Build and send a JobConfig payload to CloudVision.

    Args:
        api_endpoint: CloudVision API endpoint URL
...
def send_nodeconfig(api_endpoint: str, api_token: str, node_name: str,
